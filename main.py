...
parser.add_argument('--model_name', default='bigru')#bigru_endef
parser.add_argument('--epoch', type=int, default=10)
parser.add_argument('--aug_prob', type=float, default=0.1) 
parser.add_argument('--max_len', type=int, default=170)
parser.add_argument('--early_stop', type=int, default=5)
parser.add_argument('--root_path', default='/home2/jxy/ENDEF-SIGIR2022-main/ENDEF_en/data/')
...
deviceee = 'cuda' if torch.cuda.is_available() else 'cpu'
print("-----------正在用" + str(deviceee) + "训练-----------")
